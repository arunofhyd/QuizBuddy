          ...
          {question.options.map((option, index) => {
            ...
            if (showResults) {
              ...
              if (isSelected && isCorrect) {
                buttonClass = 'bg-green-600 text-white ring-2 ring-green-400 ring-offset-1 ring-offset-gray-800 opacity-100';
              } else if (isSelected && !isCorrect) {
                buttonClass = 'bg-red-600 text-white ring-2 ring-red-400 ring-offset-1 ring-offset-gray-800 opacity-100';
              } else if (!isSelected && isCorrect) {
                // Correct answer, not selected by player
                buttonClass = 'bg-gray-700 text-white ring-2 ring-green-400 ring-offset-1 ring-offset-gray-800 opacity-100';
              } else {
                // Not selected, not correct
                buttonClass = 'bg-gray-800 text-gray-400 opacity-50';
              }
            } else {
